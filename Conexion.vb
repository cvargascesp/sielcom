Public Class Conexion
    Public Shared strConn As String = "server=isystem.cl;database=sistema_sielcom;user=admin_sistema;password=PassSielcom123;port=3306;Connection Lifetime=86400"
